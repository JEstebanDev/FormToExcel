// Valores permitidos para los campos de habilidades técnicas.
// Portado desde Extension/src/excel/constants/allowedValues.js
...
export const COLOMBIA_DEPARTMENTS = [
  ...
  },
  {
    ...
    cities: [
      ...
      "Monterrey", "Sabanalarga", "Trinidad",
    ],
  },
  {
    department: "Cauca",
  ...
  },
  {
    ...
    cities: [
      ...
      "Fonseca", "Barrancas", "Dibulla", "Albania",
    ],
  },
  {
...
export const SENIORITY_LEVELS = ["JUNIOR", "SEMI-SENIOR", "SENIOR"];

export const SENIORITY_NIVEL_OPTIONS = [
  { value: "L1", label: "L1" },
  { value: "L2", label: "L2" },
  { value: "L3", label: "L3" },
  { value: "L4", label: "L4" },
...
export const SENIORITY_LABEL_MAP = {
  L1: "JUNIOR",
  L2: "JUNIOR",
  L3: "SEMI-SENIOR",
  L4: "SENIOR",
...
export const APPLICATIONS = [
  ...
  "SWIFT",
  "Amazon EC2",
  "Micro Focus Extra! X-treme (MyExtra)",
  "DataPower",
  "Power Apps",
  "DYNATRACE",
];
...
export const OTHERS = [
  ...
  "Lectura de logs",
  "Metodologias agiles",
  "Protocolos de comunicacion segura (SSL/TLS/FTP/SECURE)",
  "Automatizacion",
];
