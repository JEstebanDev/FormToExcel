...
export const ROLE_TECH_CATALOG = {
  frontend: {
    ...
    herramienta: ["Jscrambler", "NPM", "WebPack", "Google Analitics"],
    plataforma: ["DOCKER", "Kubernetes"],
    aplicacion: [],
    baseDeDatos: [],
  },
  backend: {
    lenguaje: ["C# (.NET Framework)", "CL", "COBOL", "Dart", "Elixir", "GO", "Java", "JavaScript", "Python", "RPG/ILE"],
    framework: ["ASP MVC", "Express", "Flask", "NPA/NHibernate", "Pandas", "Scikit-learn", "Spring Boot", "Spring Cloud", "Spring Web", "Django"],
    otros: ["AMQP", "Apache Camel", "Azure Active Directory", "BDD (Gherkin / Serenity)", "Event-driven Architecture (EDA)", "Jmeter", "JMS", "OAuth 2.0", "OpenAPI", "OpenID", "OWASP", "Pruebas de Performance", "Pruebas Unitarias", "SOLID", "Sterling", "WEB SECURITY AND THE OWASP TOP 10: THE BIG PICTURE"],
    ...
    plataforma: ["Apache Kafka", "Apache Tomcat", "CLEAR PATH", "DOCKER", "IIS", "Kubernetes", "Mockito", "Node.js", "PowerMock", "SPARK", "WAS", "WMQ"],
    aplicacion: ["Artifactory", "SWIFT"],
    baseDeDatos: ["DynamoDB", "DB2", "IBM Cloudant", "MongoDB", "MYSQL", "ORACLE", "PostgreSQL", "REDIS", "SQL Server"],
  },
  fullstack: {
    lenguaje: ["Java", "Python", "SQL", "XPATH"],
    framework: ["Angular", "ASP MVC", "BDD Framework", "Data Driven Framework", "Express", "Flask", "FRAMEWORK DE AUTOMATIZACION: SERENITY", "Karate Framework", "Next.js (SSR)", "NPA/NHibernate", "Pandas", "Playwright", "QUARKUS", "Redux", "Scikit-learn", "Spring Boot", "Spring Cloud", "Spring Web", "Spring Framework", "Universal (SSR)", "Winium", "Django"],
    otros: ["BDD (Gherkin / Serenity)", "DevOps", "Gherkin / Cucumber", "Patrón de diseño ScreenPlay", "REST", "SOAP", "SOLID", "WinAppDriver"],
    herramienta: ["Analisis Estatico (SonarQube)", "Appium", "Git", "GraphQL", "Postman", "Selenium"],
    plataforma: ["Apache Kafka", "Apache Tomcat", "AWS RDS", "DOCKER", "IIS", "Kobiton", "Kubernetes", "Mockito", "Node.js", "PowerMock", "SPARK", "WAS", "WMQ"],
    aplicacion: ["Artifactory", "Micro Focus Extra! X-treme (MyExtra)"],
    baseDeDatos: ["DynamoDB", "DB2", "IBM Cloudant", "MongoDB", "MYSQL", "ORACLE", "PostgreSQL", "REDIS", "SQL Server"],
  },
  automatizador: {
  ...
  finacle: {
    lenguaje: ["C++", "Finacle Scripting", "Java"],
    framework: [],
    otros: ["Finacle FIUI", "Finacle Pagos", "Finacle préstamos", "Finacle productos trade"],
    herramienta: ["I-reports IDE", "SQL Developer"],
    plataforma: ["AIX"],
    aplicacion: [],
    baseDeDatos: ["ORACLE"],
  },
